(function () {
  ...
  function menuService() {
    ...
    var service = {
      ...
      defaultRoles: ['customer'],//['user', 'admin'],
      getMenu: getMenu,
      menus: {},
    ...
    function addMenuItem(menuId, options) {
      ...
      if( service.menus[menuId].items.length ){
          sortMenu( service.menus[menuId].items );
      }
    ...
    function addSubMenuItem(menuId, parentItemState, options) {
      ...
      //sort menus by position
      if( service.menus[menuId].items[itemIndex].items.length ){
          sortMenu( service.menus[menuId].items[itemIndex].items );
      }
